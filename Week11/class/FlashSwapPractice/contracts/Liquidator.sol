...
contract Liquidator is IUniswapV2Callee, Ownable {
    ...
    function uniswapV2Call(address sender, uint256 amount0, uint256 amount1, bytes calldata data) external override {
        ...
        // 5. call liquidate
        // 套利、還錢
        // use 80u to liquidiate 1 ETH
        // address _usdc = IUniswapV2Pair(msg.sender).token1();
        // IERC20(callback.tokenIn).approve(_FAKE_LENDING_PROTOCOL, 80 * 10 ** 6 );
        ...
        // msg.sender 是 pair ，還錢
        IWETH(_WETH9).transfer(msg.sender, callback.amountOut);
    ...
    function liquidate(address[] calldata path, uint256 amountOut) external {
        ...
        CallbackData memory callbackData = CallbackData({
            ...
            amountOut: repayAmount // e 還回去的錢
        });
        
        // token0 e , token1 u
        // amoun0out, amount1out
        // address toen0 = IUniswapV2Pair()

        IUniswapV2Pair(pool).swap(0, amountOut, address(this), abi.encode(callbackData));
    }
